...
public class EventContentAPI extends ContentAPI{

    private static final String TAG = "EventContentAPI";

    private HashMap<String, String> header;

    public EventContentAPI() {
    ...
    public ArrayList<Content> getContents() {
        ...
        String url = "https://mplatform.seoul.go.kr/api/dule/eventList.do";
